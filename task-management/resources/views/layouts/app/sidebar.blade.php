    ...
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Platform')" class="grid">
                ...
                <flux:sidebar.item icon="chart-bar" :href="route('story-points.index')"
                    :current="request()->routeIs('story-points.index')" wire:navigate>
                    {{ __('Story Points') }}
                </flux:sidebar.item>

                <flux:sidebar.item icon="clock" :href="route('estimated-hours.index')"
                    :current="request()->routeIs('estimated-hours.index')" wire:navigate>
                    {{ __('Estimated Hours') }}
                </flux:sidebar.item>

                <flux:sidebar.item icon="rectangle-stack" :href="route('tasks.index')"
